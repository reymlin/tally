...
type EmojiObj = { [key: string]: string[] };
const emojiList: EmojiList = [
    ...
    [
        "transport-air",
        ["\u{2708}", "\u{1F6E9}", "\u{1F6EB}", "\u{1F6EC}", "\u{1FA82}", "\u{1F4BA}", "\u{1F681}", "\u{1F69F}", "\u{1F6A0}", "\u{1F6A1}", "\u{1F6F0}", "\u{1F680}", "\u{1F6F8}"]
    ],
    ...
    [
        "computer",
        ["\u{1F50B}", "\u{1F50C}", "\u{1F4BB}", "\u{1F5A5}", "\u{1F5A8}", "\u{2328}", "\u{1F5B1}", "\u{1F5B2}", "\u{1F4BD}", "\u{1F4BE}", "\u{1F4BF}", "\u{1F4C0}", "\u{1F9EE}"]
    ],
    [
        "light & video",
        [
    ...
    [
        "mail",
        ["\u{2709}", "\u{1F4E7}", "\u{1F4E8}", "\u{1F4E9}", "\u{1F4E4}", "\u{1F4E5}", "\u{1F4E6}", "\u{1F4EB}", "\u{1F4EA}", "\u{1F4EC}", "\u{1F4ED}", "\u{1F4EE}", "\u{1F5F3}"]
    ],
    ...
    [
        "transport-sign",
        ["\u{1F3E7}", "\u{1F6AE}", "\u{1F6B0}", "\u{267F}", "\u{1F6B9}", "\u{1F6BA}", "\u{1F6BB}", "\u{1F6BC}", "\u{1F6BE}", "\u{1F6C2}", "\u{1F6C3}", "\u{1F6C4}", "\u{1F6C5}"]
    ],
    [
        "warning",
        ["\u{26A0}", "\u{1F6B8}", "\u{26D4}", "\u{1F6AB}", "\u{1F6B3}", "\u{1F6AD}", "\u{1F6AF}", "\u{1F6B1}", "\u{1F6B7}", "\u{1F4F5}", "\u{1F51E}", "\u{2622}", "\u{2623}"]
    ],
    [
        "arrow",
        [
...
export function getEmojiFn() {
    ...
    for (let i = 0; i < emojiList.length; i++) {
        const [label, valueArray] = emojiList[i];
        if (label.includes("face") || label.includes("emotion")) {
            emojiObj["表情"].push(...valueArray);
        } else if (label.includes("person")) {
            emojiObj["人物"].push(...valueArray);
        } else if (label.includes("hand")) {
            emojiObj["手势"].push(...valueArray);
        } else if (label.includes("animal")) {
            emojiObj["动物"].push(...valueArray);
        } else if (label.includes("food")) {
            emojiObj["食物"].push(...valueArray);
        } else if (label.includes("plant")) {
            emojiObj["植物"].push(...valueArray);
        } else if (label.includes("building")) {
            emojiObj["建筑"].push(...valueArray);
        } else if (label.includes("drink")) {
            emojiObj["饮料"].push(...valueArray);
        } else if (label.includes("transport")) {
            emojiObj["交通"].push(...valueArray);
        } else if (label.includes("hotel")) {
            emojiObj["酒店"].push(...valueArray);
        } else if (label.includes("time")) {
            emojiObj["时间"].push(...valueArray);
        } else if (label.includes("weather")) {
            emojiObj["天气"].push(...valueArray);
        } else if (label.includes("sport")) {
            emojiObj["运动"].push(...valueArray);
        } else if (label.includes("clothing")) {
            emojiObj["服饰"].push(...valueArray);
        } else if (label.includes("music") || label.includes("sound") || label.includes("musical") || label.includes("phone") || label.includes("computer")) {
            emojiObj["娱乐"].push(...valueArray);
        } else if (label.includes("family")) {
            emojiObj["家庭"].push(...valueArray);
        } else {
            emojiObj["其他"].push(...valueArray);
        }
    }
    return emojiObj;
}
